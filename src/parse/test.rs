...
fn expression_with_grouping_left() {
    ...
    let expected_ast = {
        ...
        // RHS: 3
        expected_ast
            .add_terminal_child(mult_div_handle, Some(Token::IntLiteral(3)));
    ...
    let expected_ast = {
        ...
        // statements
        {
            ...
            // rhs: {b + c}
            {
                ...
                // expression
                {
                    let rhs_expression_handle = expected_ast
                        .add_child(brace_expression_handle, Rule::Expression);
                    add_expected_add_child(
                        &mut expected_ast,
        ...
        // statements
        {
            ...
            // LHS
            {
                ...
                let brace_expression = expected_ast
                    .add_child(expression_handle, Rule::BraceExpression);
                let expression_handle =
                    expected_ast.add_child(brace_expression, Rule::Expression);
                expected_ast.add_terminal_child(
                    expression_handle,
                    Some(Token::Symbol("a".to_owned())),
                );
    ...
    let expected_ast = {
        ...
        // statements
        {
            ...
            // LHS
            {
                ...
                let expression_handle =
                    expected_ast.add_child(fun_arg_handle, Rule::Expression);
                expected_ast.add_terminal_child(
                    expression_handle,
                    Some(Token::Symbol("a".to_owned())),
                );
...
fn add_function_call_multiple_arguments(
    ...
    {
        // recursive arg
        let args_handle = ast.add_child(args_handle, Rule::FunctionArguments);
    ...
    // arg 3
    add_terminal_expression(ast, args_handle, Some(Token::Symbol(arg3_name)));
}
